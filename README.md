...
In the following, we take **NuMaker-IoT-M263A** board as an example for Mbed CE support.

### Build the example

1.  Clone the example and navigate into it
    ```
    $ git clone https://github.com/mbed-nuvoton/NuMaker-mbed-ce-I2C-BME680-example
    $ cd NuMaker-mbed-ce-I2C-BME680-example
...
1.  Compile with cmake/ninja
    ...
    $ cmake .. -GNinja -DCMAKE_BUILD_TYPE=Develop -DMBED_TARGET=NUMAKER_IOT_M263A
    $ ninja
    $ cd ..
    ```
...
Flash by drag-n-drop built image `NuMaker-mbed-ce-I2C-BME680-example.bin` or `NuMaker-mbed-ce-I2C-BME680-example.hex` onto **NuMaker-IoT-M263A** board
